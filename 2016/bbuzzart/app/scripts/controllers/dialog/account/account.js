...
//            if($scope.loginInfo.password.length <= 5){
//                $scope.error.login.password = true;
//            }
            
//            if(!$scope.error.login.email && !$scope.error.login.password){
        ...
        $scope.loginCallback = function(res){
            if(res.success){
                ...
                userInfo.loginInfo = $scope.loginInfo;
                authSvc.setAuthKey(userInfo.auth, userInfo.loginInfo.remember);
            ...
            restApiSvc.post(restApiSvc.apiPath.changePassword, params).then(
                function(res){
                    ...
                    if(res.data.success){
                        ...
                        userInfo.loginInfo.password = params.newPassword;
                        authSvc.setUserInfo(userInfo);
                        location.reload();
                    }
                },function(res){
