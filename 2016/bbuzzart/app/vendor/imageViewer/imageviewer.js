    ...
    ImageViewer.prototype = {
        ...
        _init: function () {
            ...
            if (viewer._fullPage) {
                ...
                container.on( 'dragstart', function() { return false; } );
        ...
        hide: function () {
            if (this._fullPage) {
                this.container.fadeOut(350, function(){
                    $('.iv-loader, .iv-snap-view, .iv-image-view').remove();
                    $('#iv-container').removeClass('show');
                });
            }
        },
