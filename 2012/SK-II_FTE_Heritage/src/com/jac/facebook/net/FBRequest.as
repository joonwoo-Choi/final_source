...
{//Package
	...
	{//FBRequest Class
		...
		{//evaluateSuccess
			...
			else if(_requestMethod == URLRequestMethod.GET)
			{//text data
			...
			{//POST response
				...
				{//error
					return new FBSuccessResult(false, e.target.data);
				}//error
			}//POST response
		}//evaluateSuccess
