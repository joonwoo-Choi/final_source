...
{ 
	...
	{ 
		//private static var ins:SWFWheel = new SWFWheel();
		...
		{
			if(ins != null) throw new Error("휠 제어 클래스는 싱글톤임.");
		}
		//	싱글톤 내용 반환	
		static public function getIns():SWFWheel
		{	return ins;	}
		 */
		...
		private static function onWheelJava(e:Event):void
		{}
		/** 
		 * 
