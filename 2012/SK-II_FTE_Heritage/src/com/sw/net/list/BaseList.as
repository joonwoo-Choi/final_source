	...
	public class BaseList extends BaseClass
	{
		...
		protected function load($obj:Object = null,$method:String = ""):void
		{
			...
			if(SecurityUtil.isWeb()){
				listVar.fbAtoken = Global.getIns().accessToken;
			}else{
				listVar.fbAtoken = "AAAEnhiBKwk8BAEQ3JBaSXFsIwhZAJXcDdBTLHKzHICcNh0bRGBzZA4z4F6SvzwtABkWhqVtvxoSCas4PSZAoZC2I9KgySEdfZAfdNaqzmmojy9z62S34W";
			}
//			listVar.fbAtoken = Global.getIns().accessToken;
		...
		{	
			//받아온 xml내용 저장
			trace("onLoad:::");
			if(data.testTrace) trace(XML(URLLoader(e.currentTarget).data));
