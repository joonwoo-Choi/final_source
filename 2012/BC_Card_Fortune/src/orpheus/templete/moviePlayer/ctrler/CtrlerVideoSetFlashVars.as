package orpheus.templete.moviePlayer.ctrler
{
	...
	public class CtrlerVideoSetFlashVars extends CtrlerMoviePlayer
	{
		...
		public function videoValueSetting():void{
			...
			_model.settingLI= _model.validate(_model.parameter.setting,"n") ? String(_model.parameter.setting) : "4";
