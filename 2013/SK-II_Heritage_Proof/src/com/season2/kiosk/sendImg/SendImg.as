package com.season2.kiosk.sendImg
{
	...
	public class SendImg
	{
		...
		protected function settingImg(e:Event):void
		{
			...
			$con.totalJoinTxt.x = int($con.totalCnt.x + $con.totalCnt.width);
			$con.ageJoinTxt.x = int($con.ageCnt.x + $con.ageCnt.width);
			...
			if(totalBarY < 464) $con.totalRank.y = totalBarY;
			else $con.totalRank.y = 464;
			$con.totalRankTxt.y = $con.totalRank.y + 6;
			
			if(ageBarY < 464) $con.ageRank.y = ageBarY;
			else $con.ageRank.y = 464;
