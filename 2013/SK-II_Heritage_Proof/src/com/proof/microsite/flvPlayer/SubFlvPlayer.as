package com.proof.microsite.flvPlayer
{
	...
	public class SubFlvPlayer
	{
		...
		public function SubFlvPlayer(con:MovieClip)
		{
			$con = con;
...
//			$video.alpha = 0;
		...
		{
			TweenLite.to($con.seekBar, 0.75, {y:350, ease:Cubic.easeOut});
		...
		{		TweenLite.to($con.seekBar, 0.75, {y:377, ease:Cubic.easeOut});	}
