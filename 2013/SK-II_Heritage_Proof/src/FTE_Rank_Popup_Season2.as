package
{
	...
	[SWF(width="450", height="470", frameRate="30", backgroundColor="0xffffff")]
	
	public class FTE_Rank_Popup_Season2 extends Sprite
	{
		
		private var $main:AssetRankPopupSeason2;
		...
		public function FTE_Rank_Popup_Season2()
		{
		...
		private function init(e:Event):void
		{
			...
			$main = new AssetRankPopupSeason2();
			this.addChild($main);
