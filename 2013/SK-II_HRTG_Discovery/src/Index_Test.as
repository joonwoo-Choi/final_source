package
{
	...
	public class Index_Test extends Sprite
	{
		
		private var $main:AssetKioskIndex;
...
//			$sensor.destroy();
			...
			/**	테스트 경로	*/
			var path:String = "http://test.crm.piterahouse.com/CRM/swf/FTE_Discovery_Kiosk_Test.swf";
			/**	실 서버 경로	*/
//			var path:String = "http://crm.piterahouse.com/CRM/swf/FTE_Discovery_Kiosk.swf";
