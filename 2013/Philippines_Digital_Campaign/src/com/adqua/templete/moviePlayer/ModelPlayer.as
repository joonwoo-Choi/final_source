package com.adqua.templete.moviePlayer
{
	...
	public class ModelPlayer extends EventDispatcher
	{
		...
		public var rStgW:Number=0;// If you need to change the videoplayer width just change rStgW value
		public var rStgH:Number=0;// If you need to change the videoplayer height just change rStgH value		
