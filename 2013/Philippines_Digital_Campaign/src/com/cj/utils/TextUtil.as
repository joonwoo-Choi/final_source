package com.cj.utils 
{
	...
	public class TextUtil
	{
		 ...
		 * 
		 */		
		static public function inputTextCheck( $array:Array, $temp:Array = null ):int
		{
			var chk:int = -1;
			...
			for (var i:int = 0; i < total; i++) 
			{
				...
				if ($temp != null) {
					bool = TextUtil.textBlankCheck(txt.text, $temp[i]);
				}else {
					bool = TextUtil.textBlankCheck(txt.text);
				}
		 ...
		 * 
		 */		
		static public function textBlankCheck( $str:String, $temp:String = null ):Boolean
		{
		 ...
		 * 
		 */		
		static public function setInputTextEvent( txt:TextField, str:String ):void
		{
			txt.text = str;
